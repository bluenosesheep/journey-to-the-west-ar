...
(function(){
  ...
  function render(now){
    ...
    // MAGIC ONLY has no hand tracking or scene interaction.
    // ~24 FPS is enough for the narrative effects and keeps the page lightweight.
    const magicFrameMs=42;
  ...
  // Pause animation completely while the browser tab is hidden.
