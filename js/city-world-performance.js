...
window.ClassroomActivityMode={
 ...
 setScene(scene){
  ...
  // Every new scene begins in STORY: stop MediaPipe inference immediately.
 ...
 setStory(){
  this.mode="story";
  // PERFORMANCE: STORY is narration/scanning only. Stop MediaPipe inference,
  // but keep the existing camera stream alive for MindAR.
  window.ClassroomHandMode?.stop();
  this.apply();
 },
 setInteract(){
